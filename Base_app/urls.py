...
urlpatterns = [
    ...
    path('site-admin/api/verifications/', views.admin_api_verifications, name='admin_api_verifications'),
    path('site-admin/api/verifications/<int:verification_id>/action/', views.admin_api_verification_action, name='admin_api_verification_action'),
