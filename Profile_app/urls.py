...
urlpatterns = [
    ...
    path('api/followers/<str:username>/', views.followers_list_for_user, name='followers_list_for_user'),
    path('api/following/<str:username>/', views.following_list_for_user, name='following_list_for_user'),
